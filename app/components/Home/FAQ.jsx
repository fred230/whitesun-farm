...
export default function MyApp() {
    ...
    return (
      ...
      <div>
                <div className="relative py-16 bg-gradient-to-b from-gray-100 to-gray-50 flex justify-center items-center">
                    <div>
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-10 text-green-700">How can we help you?</h1>
                        <div className="bg-black rounded relative mt-6 lg:mt-14 py-4 pl-4 flex items-center w-full">
                            <div>
